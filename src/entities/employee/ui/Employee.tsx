  ...
  return (
    <div className="flex flex-row gap-[32px] border-b px-[8px] py-[16px] text-left">
      ...
      <div className="flex w-full flex-row items-start gap-[32px]">
        <p className="w-[28%] text-left">{employee.full_name}</p>
        <p className="w-[28%] text-left">{employee.position}</p>
        <p className="w-[14%] text-left">{employee.employment_date}</p>
        <p className="w-[28%] text-left">{employee.place_of_employment}</p>
      </div>
